...
import dotenv
from cnvizard.cnv_visualizer import cnv_visualizer, styler, exporter, plotter, helpers
import cnvlib
...
if reference_df is not None and cnr_df is not None and bintest_df is not None:
    cnv_visualizer_instance = cnv_visualizer.CNVVisualizer(reference_df, cnr_df, bintest_df)
