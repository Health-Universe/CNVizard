...
def make_pretty(styler):
        ...
        #Set the thousand seperator as , and apply it on the columns start and end 
        styler.format(subset=["start","end"],thousands=',', decimal='.')
        #Highlight values in the weight column in green which are greater or equal than 0.9
        styler.highlight_between(subset='weight', color='green', axis=0,left=0.9, right=1)
        #Highlight values in the weight column in yellow which are greater or equal to 0.8 but smaller than 1 
        styler.highlight_between(subset='weight', color='yellow', axis=0,left=0.8, right=0.9)
        #Highlight values in the weight column in yellow which are greater or equal to 0 but smaller than 0.8
        ...
        #Highlight values in the log2 column in yellow which are smaller or equal to -0,65
